...
export const getUser = catchAsyncErrors(async (req, res, next) => {
  try {
    ...
    return next(new ErrorHandler(error.message || "Failed to fetch user", 500));
  }
});
...
export const updateProfile = catchAsyncErrors(async (req, res, next) => {
  try {
    ...
    return next(new ErrorHandler(error.message || "Profile Update Failed", 500));
  }
});
...
export const updatePassword = catchAsyncErrors(async (req, res, next) => {
  try {
    ...
    return next(new ErrorHandler(error.message || "Password Update Failed", 500));
  }
});
...
export const getUserForPortfolio = catchAsyncErrors(async (req, res, next) => {
  try {
    ...
    return next(new ErrorHandler(error.message || "Failed to fetch portfolio user", 500));
  }
});
...
export const forgotPassword = catchAsyncErrors(async (req, res, next) => {
  try {
    ...
    return next(new ErrorHandler(error.message || "Forgot Password failed", 500));
  }
});
...
export const resetPassword = catchAsyncErrors(async (req, res, next) => {
  try {
    ...
    return next(new ErrorHandler(error.message || "Reset Password failed", 500));
  }
});
